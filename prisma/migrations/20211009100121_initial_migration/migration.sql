...
-- CreateEnum
CREATE TYPE "RolesType" AS ENUM ('administrador', 'usuario', 'colaborador');
...
CREATE TABLE "user_role" (
  ...
  -- AddForeignKey
  CONSTRAINT "fk_UserRole_userId" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE,
  -- AddForeignKey
  CONSTRAINT "fk_UserRole_roleId" FOREIGN KEY ("role_id") REFERENCES "roles"("id") ON DELETE CASCADE ON UPDATE CASCADE
);
